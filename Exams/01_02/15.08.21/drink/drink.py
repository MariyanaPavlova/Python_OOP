...
class Drink(ABC):
    ...
    def portion(self, value):
        Validator.raise_if_number_is_zoro_or_negative(value, "Portion cannot be less than or equal to zero!")
    ...
    def brand(self, value):
        Validator.raise_if_str_is_empty_or_whitespace(value, "Brand cannot be empty string or white space!")
        self.__brand = value
